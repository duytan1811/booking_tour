...
@section('title', 'Chi tiết tour du lịch')
@section('content')
    <div class="text-end mb-3">
        <a href="{!! route('admin.tours.index') !!}" class="btn btn-danger">Quay lại</a>
    </div>
    <div class="block block-rounded row g-0 overflow-hidden">
        <ul class="nav nav-tabs nav-tabs-block flex-md-column col-md-3 rounded-0" role="tablist">
            <li class="nav-item d-md-flex flex-md-column">
                <a href="{!! route('admin.tours.detail', ['id' => $tour->id, 'tab' => 'general']) !!}"
            ...
            <li class="nav-item d-md-flex flex-md-column">
                <a href="{!! route('admin.tours.detail', ['id' => $tour->id, 'tab' => 'comment']) !!}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <div class="row mb-3">
                                ...
                                <div>
                                    <span
                                        class="badge {{ $tour->status == 0 ? ' bg-danger' : 'bg-primary' }}">{{ $tour->status_name }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="row">
                                    ...
                                    @if ($item->status === 0)
                                        <div class="col-3 d-flex">
                                            {!! Form::open(['url' => route('admin.tours.approval', $tour->id), 'method' => 'POST', 'class' => 'me-2']) !!}
                                            ...
                                            {!! Form::open(['url' => route('admin.tours.approval', $item->id), 'method' => 'POST']) !!}
